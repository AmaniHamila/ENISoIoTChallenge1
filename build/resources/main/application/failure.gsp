        ...
        <div class="services-overlay">
            <div class="container">
                ...
                <div class="main-head">
                    ...
                    <h2 data-scroll-reveal="enter top and move 50px over 1.2s" align="center">Oops</h2>

                  <p> application failed , Try again
...
<script>
    $(function() {
        ...
        %{--$.backstretch("${assetPath(src: 'whyfailureisgoodforsuccess.jpg')}");--}%
